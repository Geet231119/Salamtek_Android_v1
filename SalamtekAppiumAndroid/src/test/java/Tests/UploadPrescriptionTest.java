...
public class UploadPrescriptionTest extends BaseTest {
	...
	@Test(description = "Verify whether user is able to upload prescription", dataProvider = "dataForUploadPrescription")
	public void UploadPrescription(String testCaseID, String testCaseName, String description,
			String executionStatus, String username, String password, String operationName) throws Exception {
		...
		testResult = uploadPrescriptionPage.verifyUploadPrescription(sheetName, testCaseID);
		if (testResult.equals(false)) {
			excelUtils.updateResult(false);
			Assert.assertEquals(testResult, true);
		}
